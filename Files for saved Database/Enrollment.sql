...
EXEC sp_rename 'Enrollment.MaidenName', 'ParentMiddleName', 'COLUMN';
ALTER TABLE Enrollment 
ALTER COLUMN ParentMiddleName VARCHAR(50) NULL;

ALTER TABLE Enrollment
ALTER COLUMN GWA DECIMAL(5,2) NOT NULL;

ALTER TABLE Enrollment
DROP CONSTRAINT IF EXISTS CK_Enrollment_GWA;

ALTER TABLE Enrollment
ADD CONSTRAINT CK_Enrollment_GWA CHECK (GWA >= 64.00 AND GWA <= 100.00);

ALTER TABLE Enrollment
ALTER COLUMN Height DECIMAL(5,2) NOT NULL;
